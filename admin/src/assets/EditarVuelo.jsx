...
function EditarVuelo() {
    ...
    useEffect(() => {
        axios.get(`https://el-dorado-backend.onrender.com/dorado/vuelos/consultar/${codVuelo}`)
            .then(response => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://el-dorado-backend.onrender.com/dorado/vuelos/editar/${codVuelo}`, {
